...
fun GitExplorerApp(
                ...
                AppScreen.EXPLORER -> {
                    if (uiState.showSearchAcrossFiles) {
                        ...
                        FileTreeExplorer(
                            ...
                            pinnedFolders = uiState.pinnedFolders,
                            pinnedFiles = uiState.pinnedFiles,
                            topPinnedFolders = uiState.topPinnedFolders,
                            topPinnedFiles = uiState.topPinnedFiles,
                            ...
                            onTogglePinFile = viewModel::togglePinFile,
                            onTogglePinFolderToTop = viewModel::togglePinFolderToTop,
                            onTogglePinFileToTop = viewModel::togglePinFileToTop,
    ...
    if (uiState.showTerminal) {
        GitHubTerminalModal(
            ...
            conflictedFiles = uiState.conflictedFiles,
            isMergeConflict = uiState.activeMergeConflict,
